...
class commodityProductController {
  ...
  async getProductMin(req: Request, res: Response) {
    const category = req.query.category;
    const product: Query<ProductDTO[]> = await db.query(
  ...
  async getProductList(req: Request, res: Response) {
    ...
    const binding = String(req.query.binding) || '';
    ...
    const product: Query<ProductDTO[]> = await db.query(tx_query_resp);
    res.json(product.rows);
  }

  async getInfoProductList(req: Request, res: Response) {
    const stock = req.query.stock;
    ...
    let tx_query_resp =
      'SELECT id, autor_id AS author_id, (SELECT name FROM autor WHERE autor.id = product.autor_id) AS author_name, binding_id, (SELECT name FROM binding WHERE binding.id = product.binding_id) AS binding, (SELECT surname FROM autor WHERE autor.id = product.autor_id) AS author_surname, manufacturer_id, (SELECT name FROM manufacturer WHERE manufacturer.id = product.manufacturer_id) AS manufacturer, publisher_id, (SELECT name FROM publisher WHERE publisher.id = product.publisher_id) AS publisher, badge_novelty, badge_discount, badge_sales_leder AS badge_sales_leader FROM product WHERE';
  ...
  async getProductOneImages(req: Request, res: Response) {
    const id = req.params.id;
    const product = await db.query(
  ...
  async getProductOneImagesList(req: Request, res: Response) {
    const id = req.params.id;
    const product = await db.query(
  ...
  async getProductOneReviews(req: Request, res: Response) {
    const id = req.params.id;
    const product: Query<ReviewDTO[]> = await db.query(

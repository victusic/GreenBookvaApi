...
router.get(
  '/product/bestseller',
  commodityProductController.getProductBestseller,
);
...
router.get(
  '/one/product/:id/images',
  commodityProductController.getProductOneImages,
);
router.get(
  '/one/product/:id/images/list',
  commodityProductController.getProductOneImagesList,
);
router.get(
  '/one/product/:id/reviews',
  commodityProductController.getProductOneReviews,
);
